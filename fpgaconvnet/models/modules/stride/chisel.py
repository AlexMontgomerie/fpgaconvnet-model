...
try:
    DEFAULT_SQUEEZE_RSC_MODELS: dict[str, ResourceModel] = { rsc_type: get_cached_resource_model(StrideChisel,
                                    rsc_type, "default") for rsc_type in DEFAULT_CHISEL_PLATFORM.resource_types }
except FileNotFoundError:
    print("CRITICAL WARNING: default resource models not found for Stride, default resource modelling will fail")

@eval_resource_model.register
def _(m: StrideChisel, rsc_type: str, _model: Optional[ResourceModel] = None) -> int:
