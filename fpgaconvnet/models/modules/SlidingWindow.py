...
class SlidingWindow(Module):
    ...
    def rate_in(self):
        ...
        return (self.rows_in()*self.cols_in())/float((self.rows_in()+self.pad_right+self.pad_left)*(self.cols_in()+self.pad_top+self.pad_bottom)) # TODO: maybe need to reduce for padding effect
