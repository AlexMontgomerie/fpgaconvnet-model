...
try:
    DEFAULT_POOL_RSC_MODELS: dict[str, ResourceModel] = { rsc_type: get_cached_resource_model(PoolHLS,
...
def _(m: PoolHLS, rsc_type: str, _model: Optional[ResourceModel] = None) -> int:
