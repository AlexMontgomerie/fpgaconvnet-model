...
from fpgaconvnet.models.layers.convolution.chisel import ConvolutionLayer2DBase
from fpgaconvnet.architecture import Architecture, BACKEND, DIMENSIONALITY

@dataclass(kw_only=True)
class ConvolutionLayerSparseChisel(ConvolutionLayer2DBase):
...
@dataclass(kw_only=True)
class ConvolutionLayerSparsePointwiseChisel(ConvolutionLayer2DBase):
...
@dataclass(kw_only=True)
class ConvolutionLayerSparseSkippingChisel(ConvolutionLayer2DBase):
...
#@dataclass(kw_only=True)
#class ConvolutionLayerSparseChisel(ConvolutionLayerChisel):
...
#                np.prod(self.kernel_size)//self.fine
