...
def check_resources(self):
    ...
    for partition in self.partitions:
        ...
        assert partition_resource_usage['FF']   <= (self.platform.resources['FF']), "ERROR: FF usage exceeded"
        assert partition_resource_usage['LUT']  <= (self.platform.resources['LUT']), "ERROR: LUT usage exceeded"
        assert partition_resource_usage['DSP']  <= (self.platform.resources['DSP']) , "ERROR: DSP usage exceeded"
        assert partition_resource_usage['BRAM'] <= (self.platform.resources['BRAM']), "ERROR: BRAM usage exceeded"
