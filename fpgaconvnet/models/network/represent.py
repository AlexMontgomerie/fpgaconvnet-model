...
def save_all_partitions(self, filepath, input_output_from_model=True):
    ...
    for i in range(len(self.partitions)):
        ...
        # set the model input and output nodes
        self.partitions[i].model_input_nodes = self.get_model_input_nodes(i)
        self.partitions[i].model_output_nodes = self.get_model_output_nodes(i)

        # add partition info
        self.partitions[i].partition_info(partition, id=i)
